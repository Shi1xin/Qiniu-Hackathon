"""
Navigation data models for CLI Navigation Tool.

Contains core data structures for representing navigation queries, locations,
route parameters, and processing results.
"""
...
class QueryType(str, Enum):
    """Type of navigation query based on location types."""
...
class LocationEntity(BaseModel):
    """Represents a parsed location with metadata and confidence scoring."""
...
class BrowserSession(BaseModel):
    """Represents a browser session state and metrics."""
    ...
    launched_at: Optional[datetime] = Field(None, description="Launch timestamp")
